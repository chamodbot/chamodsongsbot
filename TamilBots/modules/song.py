...
async def song(client, message):
    ...
    if message.from_user.id not in AUTH_USERS:
        await message.send_message("**⛔️ Access Denied ⛔️**\n\n**Please Contact** @chamod_deshan to **Get Access** or Join @zoneunlimited to Access **This Service** 🌷")
        return ""
    add_chat_to_db(str(chat_id))
    args = get_arg(message) + " " + "song"
    if args.startswith(" "):
        await message.send_message("**🧐 My owner is not admin this group or chanle !! ..**")
        return ""
    status = message.send_message("**🌷 Updating Music Savers ....**",
...
def song(_, message):
    ...
    m = message.send_message("**🎵 Searching Music Savers ....**",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("░░░░░░░░░░░░░░░░", callback_data="progress_msg")]]))
