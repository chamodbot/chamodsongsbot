...
def song(_, message):
    ...
    try:
        ...
        rep = (f"[{title[:35]}]({link})\n\n┏━━━━━━━━━━━━━━━━━┓\n\n┣★ Duration : `{duration}`\n\n┣★ Views : {views}\n\n┣★ **✅ Successfully Downloaded to MP3 🎵**\n\n┣★ 🌺 Requestor : {message.from_user.first_name } \n\n┣★ 🌷 Downloaded by : [MUSIC FINDER BOT 🎵](https://t.me/The_song_finder_bot)\n\n┣★ [🍀 zoneunlimited 🍀](https://t.me/zoneunlimited)Corporation ©️\n\n┗━━━━━━━━━━━━━━━━━┛\n\n__",reply_to_message_id = message.message_id , parse_mode="markdown", reply_markup=InlineKeyboardMarkup(            [                [                    InlineKeyboardButton("🔥 nikoneDevelopers 🔥" ,url="https://t.me/nikoneDevelopers") ],                 [InlineKeyboardButton("🌺 nikoneDevelopers help 🌺", url="https://t.me/nikone_Developers"),InlineKeyboardButton("🎓 nikoneDevelopers ssh hub 🎓",url = "https://t.me/nikonesshhub") ]           ]        ) )
